...
run_check 'PauseReason exists' grep -qF -- 'pub enum PauseReason' "${ROOT}/src/domain/mod.rs"
run_check 'PauseReason uses snake case' grep -qF -- 'rename_all = "snake_case"' "${ROOT}/src/domain/mod.rs"
