...
run_test "s6_non_int_meta_user_version_17" \
  "sqlite3 $NIR_HOME/meta.sqlite 'PRAGMA user_version' | grep -qE '^17$'"
...
run_test "s6_mode_fast_user_version_17" \
  "sqlite3 $HOME_FAST/meta.sqlite 'PRAGMA user_version' | grep -qE '^17$'"
...
run_test "s6_mode_standard_user_version_17" \
  "sqlite3 $HOME_STD/meta.sqlite 'PRAGMA user_version' | grep -qE '^17$'"
...
run_test "s6_mode_deep_user_version_17" \
  "sqlite3 $HOME_DEEP/meta.sqlite 'PRAGMA user_version' | grep -qE '^17$'"
...
run_test "s6_mode_batch_user_version_17" \
  "sqlite3 $HOME_BATCH/meta.sqlite 'PRAGMA user_version' | grep -qE '^17$'"
