...
| Documentation / ADRs            | `docs/adr/**`, `AGENTS.md`, `docs/branch-protection.md`, `docs/events-v1.md`    | @airvzxf  | ADR-NNNN format; numbering is sequential; consult the latest ADR before proposing a structural change. |
