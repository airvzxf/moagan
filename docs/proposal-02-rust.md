...
|---|---|---|---|
| 1 | "Sketches de 400–800 tokens" sin tope duro para outputs de LLM | `max_tokens` por rol en `prompts/registry.rs`; para sketch → 1024 (margen para formateo). | Evita truncamientos ambiguos. |
| 2 | "Tagger ligero" sin parámetros | Tagger: `temperature=0`, `top_p=0.2`, `max_tokens=512`, JSON mode forzado. | Determinismo + concisión. |
...
```json
{
  ...
  "request": { "messages": [...], "temperature": 0.6, "top_p": 0.95, "max_tokens": 1024 },
  "response": { "raw": "...", "parsed": {...} },
...
|---|---|---:|---:|---:|---|
| `intake` | Normalizar el prompt | 0.0 | 0.2 | 1024 | true |
| `clarify` | Detectar ambigüedades | 0.2 | 0.8 | 2048 | true |
| `router` | Decidir modo | 0.0 | 0.2 | 512 | true |
| `decomposer` | DAG (sólo deep) | 0.3 | 0.9 | 3000 | true |
| `sketcher` | Sketch corto | 0.7 | 0.95 | 1024 | true |
| `proposer` | Propuesta completa | 0.6 | 0.95 | 6000 | true |
| `critic_correctness` | Crítica de corrección | 0.2 | 0.8 | 4000 | true |
| `critic_constraint` | Crítica de ajuste | 0.2 | 0.8 | 4000 | true |
| `critic_security` | Crítica de seguridad | 0.2 | 0.8 | 4000 | true |
| `judge_correctness` | Juez 1 | 0.0 | 0.2 | 1500 | true |
| `judge_completeness` | Juez 2 | 0.0 | 0.2 | 1500 | true |
| `judge_feasibility` | Juez 3 | 0.0 | 0.2 | 1500 | true |
| `adversary` | Revisión adversaria | 0.3 | 0.9 | 4000 | true |
| `repairer` | Reparación | 0.4 | 0.9 | 6000 | true |
| `tagger` | Tags discovery | 0.0 | 0.2 | 512 | true |
| `facet_deriver` | Facetas discovery | 0.0 | 0.2 | 1024 | true |
| `extractor` | Extracción por faceta | 0.2 | 0.8 | 3000 | true |
| `integrator` | Borrador integrado | 0.3 | 0.9 | 4000 | true |
| `refiner` | Refinador de fluency | 0.2 | 0.8 | 4000 | true |
