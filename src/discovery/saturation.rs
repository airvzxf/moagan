...
/// top of the saturation point. The v0.5 PR-19 verification
/// ("con --cardinality 100 y saturación al 50%, el run termina
/// con ~60 sketches") defines the saturation point as 50% of
/// the target. The reserve is `reserve_ratio` of that saturation
/// point, not of the full
